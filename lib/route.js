...
Router.prototype.resource = function(route, resource) {
  ...
  if (resoure.list) this.get(route+'/projects', function (req, res) {resource.list(req, res, db))});
  if (resoure.create) this.post(route+'/projects', function (req, res) {resource.create(req, res, db))});
  if (resoure.read) this.get(route+'/projects/:id', function (req, res) {resource.read(req, res, db))});
  if (resoure.update) this.post(route+'/projects/:id', function (req, res) {resource.update(req, res, db))});
  if (resoure.destroy) this.get(route+'/projects/:id/destroy', function (req, res) {resource.destroy(req, res, db))});
}
